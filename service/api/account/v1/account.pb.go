...
type GetAccountReply struct {
	...
	UserID  uint64 `protobuf:"varint,6,opt,name=userID,proto3" json:"userID,omitempty"`   // 用户表ID
}
...
func (x *GetAccountReply) GetUserID() uint64 {
	if x != nil {
		return x.UserID
	}
	return 0
...
func (x *BindUserReq) GetId() uint64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *BindUserReq) GetUserID() uint64 {
	if x != nil {
		return x.UserID
	}
	return 0
...
var file_api_account_v1_account_proto_rawDesc = []byte{
	...
	0x42, 0x07, 0xfa, 0x42, 0x04, 0x32, 0x02, 0x20, 0x00, 0x52, 0x02, 0x69, 0x64, 0x22, 0x9b, 0x01,
	...
	0x01, 0x28, 0x04, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x44, 0x22, 0x37, 0x0a, 0x14, 0x45,
	...
	0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x02, 0x69, 0x64, 0x22, 0x74, 0x0a, 0x0f,
	...
	0x32, 0x02, 0x20, 0x00, 0x52, 0x02, 0x69, 0x64, 0x12, 0x2a, 0x0a, 0x0a, 0x63, 0x69, 0x70, 0x68,
	...
	0x1f, 0x0a, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x44, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x42,
	...
	0x6b, 0x65, 0x79, 0x32, 0xae, 0x04, 0x0a, 0x07, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x12,
...
var file_api_account_v1_account_proto_depIdxs = []int32{
	...
	10, // 5: account.v1.Account.BindUser:input_type -> account.v1.BindUserReq
	12, // 6: account.v1.Account.GetKey:input_type -> account.v1.GetKeyReq
	1,  // 7: account.v1.Account.CreateEMailAccount:output_type -> account.v1.CreateEMailAccountReply
	3,  // 8: account.v1.Account.GetAccount:output_type -> account.v1.GetAccountReply
	5,  // 9: account.v1.Account.ExistAccountEMail:output_type -> account.v1.ExistAccountEMailReply
	7,  // 10: account.v1.Account.VerifyPassword:output_type -> account.v1.VerifyPasswordReply
	9,  // 11: account.v1.Account.SavePassword:output_type -> account.v1.SavePasswordReply
	11, // 12: account.v1.Account.BindUser:output_type -> account.v1.BindUserReply
	13, // 13: account.v1.Account.GetKey:output_type -> account.v1.GetKeyReply
